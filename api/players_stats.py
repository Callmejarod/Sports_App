...
def get_player_stats():
    ...
    try:
        ...
        for player in player_data:
            ...
            Passing_completion_percentage = player.get(
...
def get_passing_player_stats():
    ...
    for player in active_players_json:
        for player_stat in player_stats_json:
            if player.get("player_id") == player_stat.get(
                "player_id",
            ):
                ...
                if player_stat.get("passing_attempts") > 0:
                    ...
                    passing_stats_dictionary = {
                        ...
                        "passing_completions": player_stat.get(
                            "passing_completions", 0
                        ),
                        "passing_completion_percentage": player_stat.get(
